        ...
        <v-layout column align-center justify-center my-3>
            ...
            <v-flex>
                <v-layout align-center justify-center>
                    <v-flex xs10>
                        <span style="font-size: 16px">While Terawatt-hours (TWh) are a standard unit of energy used to measure energy production and consumption, it can be difficult for laymen to assess without additional context.
