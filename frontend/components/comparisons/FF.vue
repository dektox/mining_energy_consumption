<template>
    <v-flex my-4 pa-3>
        ...
        <v-layout my-4>
          <span>
              <b>Source:</b><br/>
              <a src="https://www.nrdc.org/sites/default/files/home-idle-load-IP.pdf">NRDC Issue Report (2015)</a>; own calculations
          </span>
        </v-layout>
        <v-layout align-center justify-center>
            <h3 class="headline font-weight-bold">
                ...
                <v-card elevation="5">
                    <v-flex pa-4>
                        ...
                        <v-layout align-center justify-center mt-4>
                            <v-flex xs3 pa-3>
                                <v-flex>
                                    <img src="~static/images/funFacts/image13.png" object-fit="contain" width="100%">
                                </v-flex>
                            </v-flex>
                            <v-flex xs9 pa-3>
                                <v-layout align-center justify-center>
        ...
        <v-layout my-4>
          <span>
              <b>Source:</b><br/>
              <a src="https://www.sciencedirect.com/science/article/pii/S0306261916303579">Murray et al. (2016)</a>, est. 2012; <a src="https://www.research.manchester.ac.uk/portal/files/62970175/Environmental_sustainability_of_kettles.pdf">Fisher et al. (2014);</a> own calculations
          </span>
        </v-layout>
        <v-layout align-center justify-center>
            <h3 class="headline font-weight-bold">
        ...
        <v-layout align-center justify-center my-3>
            <v-flex xs10 ma-3 class="text-xs-center">
                <v-card elevation="5">
                    <v-flex pa-4>
                        <v-flex>
                            <span>The amount of electricity used annually by the Bitcoin network
                                could <b>satisfy the energy needs</b> of the University of Cambridge for ...</span>
                        </v-flex>
                        <v-layout align-center justify-center mt-4>
                            <v-flex xs6 pa-3>
                                <v-flex>
                                    <img src="~static/images/funFacts/Cambridge_logo.png" object-fit="contain" width="60%">
                                </v-flex>
                            </v-flex>
                            <v-flex xs6 pa-3>
        ...
        <v-layout my-4>
          <span>
              <b>Source:</b><br/>
              <a src="https://www.environment.admin.cam.ac.uk/facts-figures">University of Cambridge</a>
          </span>
        </v-layout>
    </v-flex>
</template>
