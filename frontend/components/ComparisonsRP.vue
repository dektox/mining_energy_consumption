    ...
    <v-flex mb-3>
        ...
        <v-layout v-bind="binding" align-center justify-center>
            <v-flex xs3 ma-3 class="text-xs-center">
                <v-card elevation="5">
                    <v-flex pa-4>
                        <span><strong>Biofuel and waste electricity generation</strong></span><br/><br/>
                        ...
                        <span style="font-size: 32px"><b>{{ 577 / numbers[0] | decimals }} times</b></span>
                    </v-flex>
                </v-card>
            </v-flex>
            <v-flex xs3 ma-3 class="text-xs-center">
                <v-card elevation="5">
                    <v-flex pa-4>
                        ...
                        <span style="font-size: 32px"><b>{{ 1405 / numbers[0] | decimals }} times</b></span>
                    </v-flex>
                </v-card>
            </v-flex>
            <v-flex xs3 ma-3 class="text-xs-center">
                <v-card elevation="5">
                    <v-flex pa-4>
                        ...
                        <span style="font-size: 32px"><b>{{ 4164 / numbers[0] | decimals }} times</b></span>
                    </v-flex>
                </v-card>
            </v-flex>
        </v-layout>
